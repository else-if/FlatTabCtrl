...
void ControlsColorMap::SetDefaultColors()
{
    ...
    m_ColorMap[ReadOnly][Border] = RGB(153, 152, 158);
    m_ColorMap[ReadOnly][BorderLight] = RGB(153, 152, 158);
    m_ColorMap[ReadOnly][BackgroundTopGradientStart] = RGB(240, 240, 240);
    m_ColorMap[ReadOnly][BackgroundTopGradientFinish] = RGB(240, 240, 240);
    m_ColorMap[ReadOnly][BackgroundBottomGradientStart] = RGB(240, 240, 240);
    m_ColorMap[ReadOnly][BackgroundBottomGradientFinish] = RGB(240, 240, 240);
}
